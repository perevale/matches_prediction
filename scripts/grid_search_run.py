...
print("EXP:|{}| embed_dim={}, n_conv={}, conv_dims={}\n".
            format(exp_counter, parameters["embed_dim"], parameters["n_conv"], parameters['conv_dims']))

acc = run_gnn_cont(input_filename,dir_prefix=sys.argv[3], exp_num=int(exp_counter), embed_dim=int(parameters["embed_dim"]),
                    n_conv=int(parameters["n_conv"]), conv_dims=to_int(parameters["conv_dims"]))

print("EXP:|{}| embed_dim={}, n_conv={}, conv_dims={} achieved accuracy:|{}|\n".
        format(exp_counter, parameters["embed_dim"], parameters["n_conv"],
               parameters["conv_dims"], acc))

with open(output_filename, "a+") as f:
    f.write("EXP:|{}| embed_dim={}, n_conv={}, conv_dims={} achieved accuracy:|{}|\n".
            format(exp_counter, parameters["embed_dim"], parameters["n_conv"], parameters["conv_dims"], acc))
